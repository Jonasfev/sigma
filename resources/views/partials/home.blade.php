...
{{-- menu com duas ações: Recursos e o Versionamento --}}
    <div class="pg-ctn bg-light d-flex align-items-center justify-content-around m-auto w-100">
        <div class="ctn-act align-items-center col-8">
            <a href="{{Route('admin.recursos', ['tipo' => 'uc'])}}" class="act d-flex m-4 p-3 flex-column align-items-center w-80">
                <img src="../img/editar.png" alt="Editar Recurso" width="100vw" class="mt-3">
                <p class="my-3">RECURSOS</p>
            </a>
            <a href="{{Route('admin.csv')}}" class="act d-flex m-4 p-3 flex-column align-items-center w-80">
