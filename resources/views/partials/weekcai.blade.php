...
{{-- mostra os horarios do cai para visualização --}}
        ...
        <div class="day w-18 h-100 mx-auto d-flex flex-column" id="{{$day}}">
            ...
            <div class="container w-100 d-flex flex-fill p-0 border border-secondary rounded-lg">
                <div class="turma-a border-right border-secondary w-50 h-100">
                    @for ($i = 0; $i < 4; $i++)
                    <div id="aula-{{$j*8+$i+1}}" class="aula w-100 h-25 @if($i < 3) border-bottom @endif border-secondary d-flex flex-column justify-content-center">
                        <div class="mt-1 amb w-100 d-flex justify-content-center">
                            <small></small>
                        </div>
                        <div class="uc w-100 flex-fill d-flex align-items-center justify-content-center text-center">
                        </div>
                        <div class="doc w-100 pb-1 d-flex align-items-center justify-content-center">
                            <small></small>
                        </div>
                    </div>
                    @endfor
                ...
                <div class="turma-b border-secondary w-50 h-100">
                    @for ($i = 0; $i < 4; $i++)
                    <div id="aula-{{$j*8+$i+5}}" class="aula w-100 h-25 @if($i < 3) border-bottom @endif border-secondary d-flex flex-column justify-content-center">
                        <div class="mt-1 icon amb w-100 d-flex justify-content-center">
                            <small></small>
                        </div>
                        <div class="uc w-100 flex-fill d-flex align-items-center justify-content-center text-center">
                        </div>
                        <div class="doc w-100 p-1 d-flex align-items-center justify-content-center">
                            <small></small>
                        </div>
                    </div>
                    @endfor
